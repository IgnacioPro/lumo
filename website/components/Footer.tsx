...
export default function Footer() {
  ...
  const links = {
    ...
    company: [
      ...
      { label: 'Contact', href: 'mailto:hello@lumo.dev' },
    ],
  };

  return (
    <footer className="bg-deep-navy text-gray-300">
      <Container className="py-12">
        ...
        <div className="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <span className="font-display font-bold text-xl text-white">Lumo</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="text-sm">
              ...
              <span className="text-electric-green">♥</span> by the Lumo team
            </span>
          </div>
        </div>
      </Container>
